...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,			  }, "r",      function () awful.spawn("dmenu_run -h 24")                      end,
              {description = "launch dmenu (run)",                    group = "launcher"}),
    awful.key({ modkey,			  }, "d",      function () awful.spawn("emacs")                          end,
              {description = "launch emacs (doom)",                   group = "launcher"}),
    awful.key({ modkey,           }, "e",      function () awful.spawn("alacritty -e ranger")            end,
              {description = "launch ranger",                         group = "launcher"}),
    awful.key({ modkey,           }, ".",      function () awful.spawn("alacritty -e ranger .config")    end,
              {description = "open ~/.config/",                       group = "launcher"}),
    awful.key({ modkey,           }, "/",      function () awful.spawn("alacritty -e ranger /")          end,
              {description = "open /",                                group = "launcher"}),
    awful.key({ modkey,    "Mod1" }, "e",      function () awful.spawn(filemanager)                      end,
              {description = "launch filemanager",                    group = "launcher"}),
    awful.key({ modkey,           }, "p",      function () awful.spawn("passmenu -h 24")                       end,
    ...
    awful.key({ modkey,    "Mod1" }, "Return",
              function ()
                  awful.spawn("alacritty --class floating-term -d 120 30")
              end,
              {description = "open a floating terminal",              group = "launcher"}),

    awful.key({ modkey,    "Mod1" }, "p",
              function ()
                  awful.spawn("alacritty --class floating-term -d 120 30 -e python")
              end,
              {description = "open a floating python window",         group = "launcher"}),

    awful.key({ modkey,           }, "t",
              function ()
                  awful.spawn("emacs ~/Documents/todo.org")
              end,
