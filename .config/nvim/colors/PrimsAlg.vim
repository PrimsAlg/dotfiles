...
" TODO: fix comments
let s:gb.bright_red     = ['#fb3d66', 167]     " 251-73-52
let s:gb.bright_green   = ['#cd5389', 109]     " 131-165-152
let s:gb.bright_yellow  = ['#fabd2f', 214]     " 250-189-47
let s:gb.bright_blue    = ['#53a6a6', 142]     " 184-187-38
let s:gb.bright_purple  = ['#d3869b', 175]     " 211-134-155
let s:gb.bright_aqua    = ['#8769c0', 108]     " 142-192-124
let s:gb.bright_orange  = ['#477ab3', 208]     " 254-128-25

let s:gb.neutral_red    = ['#bb2d4c', 124]     " 204-36-29
let s:gb.neutral_green  = ['#a64570', 66]      " 69-133-136
let s:gb.neutral_yellow = ['#d79921', 172]     " 215-153-33
let s:gb.neutral_blue   = ['#287373', 106]     " 152-151-26
let s:gb.neutral_purple = ['#b16286', 132]     " 177-98-134
let s:gb.neutral_aqua   = ['#6c50a1', 72]      " 104-157-106
let s:gb.neutral_orange = ['#395573', 166]     " 214-93-14
